...
public class ArtifactInstaller {
    ...
    public void execute() {
        ...
        if (project.getPackaging().equals("jar") || (project.getPackaging().equals("war") && project.getParent() == null)) {
         ...
         //   copyGeneratedObjects(this.sourceDirectory, this.destinationDirectory, "**/morphia/aspect/**/*.java");
            if (genericCore) {
        ...
        if (project.getPackaging().equalsIgnoreCase("war")) {
            ...
            if ("jsf".equalsIgnoreCase(webFramework)) {
                ...
                //installSpringValidation(path);
                installSpringViews(path);
            ...
            installInternationalizationKeys(webFramework,path);
    ...
    private void installSpringValidation(String path) {
    ...
    private void installSpringViews(String path) {
    	/*if(System.getProperty("parent")!=null && ! "".equals(System.getProperty("parent"))){
    		Copy copy = (Copy) antProject.createTask("copy");
            copy.setFile(new File(sourceDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/"+ pojoName + "Of"+System.getProperty("parent")+"Form.jsp"));
            copy.setTofile(new File(destinationDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/" + pojoName + "Of"+System.getProperty("parent")+"Form.jsp"));
            copy.execute();

            copy.setFile(new File(sourceDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/" + pojoName + "Of"+System.getProperty("parent")+"List.jsp"));
            copy.setTofile(new File(destinationDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/" + pojoName + "Of"+System.getProperty("parent")+"List.jsp"));
            copy.execute();
    	}else{*/
    		Copy copy = (Copy) antProject.createTask("copy");
            copy.setFile(new File(sourceDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/"+ pojoName + "Form.jsp"));
            copy.setTofile(new File(destinationDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/" + pojoName + "Form.jsp"));
            copy.execute();

            copy.setFile(new File(sourceDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/" + pojoName + "List.jsp"));
            copy.setTofile(new File(destinationDirectory + "/src/main/webapp/WEB-INF/pages/" +path+"/" + pojoName + "List.jsp"));
            copy.execute();
    	//}
    ...
    private void installStrutsViews() {
        ...
        copy.setTofile(new File(destinationDirectory + "/src/main/webapp/WEB-INF/pages/" + pojoName + "List.jsp"));
        copy.execute();
    }
    ...
    private void installInternationalizationKeys(String webFramework,String path) {
        createLoadFileTask("src/main/resources/" + pojoName + "_ApplicationResources.properties", "i18n.file").execute();
        File existingFile = new File(destinationDirectory + "/src/main/resources/ApplicationResources-"+path+"_zh_CN.properties");
